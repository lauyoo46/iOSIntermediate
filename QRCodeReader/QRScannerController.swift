...
class QRScannerController: UIViewController {
    ...
    func launchApp(decodedURL: String) {
        ...
        let alertPrompt = UIAlertController(title: "Open App", message: "Opening \(decodedURL)", preferredStyle: .actionSheet)
        ...
        if let safeMetadataObj = metadataObj {
            ...
            if supportedCodeTypes.contains(safeMetadataObj.type) {
                ...
                if safeMetadataObj.stringValue != nil {
                    ...
                    launchApp(decodedURL: safeMetadataObj.stringValue ?? "")
                }
            }
